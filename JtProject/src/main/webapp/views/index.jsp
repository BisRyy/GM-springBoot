              ...
              <div class="container text-center">
                <div class="row">
                  <div class="col-sm-6 image">
                    <div class="item">
                      <h1>Today's Deal</h1>
                      <img class="img-fluid" src="https://bisry.me/GM/IP/images/unamed.jpg" alt="">
                    </div><!--enditem-->
                  </div><!--endcol-->
                  <div class="col-sm-6">
                    ...
                    <div class="details">
                      <h2 class="cr3"> Wheat</h2>
                        <p class="cr4">100KG<br> Grinded | Grain</p>
                      <div class="rating">
          ...
          <div class="container text-center">
            <div class="row">
              <div class="col-sm-6 image">
                <div class="item">
                  <h1>Today Deal</h1>
                  <img class="img-fluid" src="https://github.com/bisryy.png">
                </div><!--enditem-->
              </div><!--endcol-->
              <div class="col-sm-6">
                <div class="top d-flex justify-content-center">
          ...
          <div class="container text-center">
            <div class="row">
              <div class="col-sm-6 image">
                <div class="item">
                  <h1>10% Discount</h1>
                    <img class="img-fluid" src="https://github.com/cypghost.png">
                </div><!--enditem-->
              </div><!--endcol-->
              <div class="col-sm-6">
                <div class="top d-flex justify-content-center">
...
<div class="row">
   <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" data-aos="zoom-in-down">
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" data-aos="zoom-in-down">
        <div class="card">
            <a class="img-card">
                <img src="https://bisry.me/GM/IP/images/about.png" />
            </a>
            <div class="card-content">
                <h4 class="card-title">
                    All Grain are Here.
