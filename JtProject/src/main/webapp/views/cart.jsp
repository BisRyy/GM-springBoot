        ...
        <div class="cart-page">
            <div class="cart-items">
                <table>
                    ...
                    <tbody>
                    <tr>
                        <td style="width: 20%;"><img src="../views/img/product/img1.jpg"></td>
                        <td style="width: 60%;">
                            <h2>Product Title</h2>
                    ...
                    <tr>
                        <td style="width: 20%;"><img src="../views/img/product/img2.jpg"></td>
                        <td style="width: 60%;">
                            <h2>Product Title</h2>
                            <p >Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                            <br>
                    ...
                    <tr>
                        <td style="width: 20%;"><img src="../views/img/product/img3.jpg"></td>
                        <td style="width: 60%;">
                            <h2>Product Title</h2>
                            <p >Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                            <br>
